...
const PAGES = [
  ...
  { name: '11a_report_projects_active',   url: '/reports/projects-active',       waitFor: '.card' },
  { name: '11b_report_tasks_by_dev',      url: '/reports/tasks-by-developer',    waitFor: '.card' },
  { name: '11c_report_tasks_overdue',     url: '/reports/tasks-overdue',         waitFor: '.card' },
  { name: '11d_report_project_progress',  url: '/reports/project-progress',      waitFor: '.card' },
  { name: '11e_report_hours_summary',     url: '/reports/hours-summary',         waitFor: '.card' },
  { name: '11f_report_workload',          url: '/reports/workload',              waitFor: '.card' },
  { name: '11g_report_time_efficiency',   url: '/reports/time-efficiency',       waitFor: '.card' },
  { name: '11h_report_task_distribution', url: '/reports/task-distribution',     waitFor: '.card' },
