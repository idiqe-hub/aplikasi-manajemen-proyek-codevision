...
@section('title', 'Papan Kanban')
@section('page_title', 'Papan Kanban')

@section('content')

{{-- Header Kustom dengan Tombol Switch --}}
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Papan Kanban</h1>
    <div>
        ...
        @if(auth()->user()->role === 'admin')
            <a href="{{ route('tasks.create') }}" class="btn btn-sm btn-primary shadow-sm ml-2">
                <i class="fas fa-plus fa-sm text-white-50 mr-1"></i> Tambah Tugas
            </a>
        @endif
    </div>
</div>
        ...
        <div class="card shadow h-100">
            <div class="card-header py-3 bg-secondary">
                <h6 class="m-0 font-weight-bold text-white text-uppercase">
                    <i class="fas fa-clipboard-list mr-1"></i> Belum Dikerjakan
